...
Under the hood, Prisma Migrate uses a [shadow database](/orm/prisma-migrate/understanding-prisma-migrate/shadow-database) to detect a [schema drift](/orm/prisma-migrate/understanding-prisma-migrate/shadow-database#detecting-schema-contexttrail) and generate new migrations.
...
:::info[Schema Drift]
A [schema drift](/orm/prisma-migrate/workflows/troubleshooting#schema-contexttrail) occurs when your database schema is out of sync with your migrations history and migrations table.
:::
